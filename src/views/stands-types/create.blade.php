...
@section('buttons')
<a href="{{url('admin/stands-types')}}" class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="{{trans('generals.back')}}"><i class="fas fa-chevron-left"></i></a>
@endsection
@section('content')
<div class="container">
    @if ($errors->any())
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" name="size" class="form-control" value="{{ old('size') }}">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="max_number_modules" min="1" class="form-control" value="{{ old('max_number_modules') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="en-pages-tab" role="tabpanel" aria-labelledby="en-tab">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <strong>{{trans('tables.size')}} ({{trans('generals.mq')}})</strong>
                                            <input type="number" min="1" name="size_en" class="form-control" value="{{ old('size_en') }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="price_en" class="form-control" value="{{ old('price_en') }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <strong>{{trans('tables.max_n_modules')}}</strong>
                                            <input type="number" name="max_number_modules_en" min="1" class="form-control" value="{{ old('max_number_modules_en') }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
